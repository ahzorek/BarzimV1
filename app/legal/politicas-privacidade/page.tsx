  ...
  return (
    <div className="w-2/4 mx-auto px-4 py-8">
      ...
      <p className="text-gray-700 mb-4">
        A sua privacidade é importante para nós. É política do Barzim respeitar
      ...
      <p className="text-gray-700 mb-4">
        ...
        informação que o Barzim oferece no site e com caráter enunciativo, mas
        não limitativo:
      </p>
      <ul className="list-disc ml-6 text-gray-700 mb-4">
        ...
        <li>
          ...
          (softwares) do Barzim, de seus fornecedores ou terceiros, para
